...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    private List<String> nodesInWay = new ArrayList<>();
...
//            System.out.println("Node lat: " + attributes.getValue("lat"));
            ...
            GraphDB.Node n = new GraphDB.Node(attributes.getValue("id"), attributes.getValue("lat"), attributes.getValue("lon"));
            g.addNode(n);
...
//            System.out.println("Id of a node in this way: " + attributes.getValue("ref"));
            ...
            nodesInWay.add(attributes.getValue("ref"));
